...
public class LoginActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginView = (EditText) findViewById(R.id.email);
...
//        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            RestConnectionUtil restConnectionUtil = new RestConnectionUtil();
            try {
                restConnectionUtil.GET("http://192.168.1.5:8080/api/get_all_fridges", login, mPassword);
            } catch (IOException e) {
                return false;
            }
            return true;
